...
public class DashboardView implements Serializable {
	...
	public void init() {
		...
		column1.addWidget("finance1");

		column2.addWidget("lifestyle");
		column2.addWidget("weather");
		column2.addWidget("weather1");

		column3.addWidget("NC");
		column3.addWidget("politics1");
	...
	public void handleReorder(DashboardReorderEvent event) {
		FacesMessage message = new FacesMessage(); //Coments for commit
		message.setSeverity(FacesMessage.SEVERITY_INFO);
		message.setSummary("Reordenar: " + event.getWidgetId());
